			...
			<thead>
				<tr>
				 	<td colspan="7" align="center">
				 		...
				 		<h1 style="margin:0">APOTEK ASSIPA WAY KANDIS</h1>
				 		<h4 style="margin:0;margin-top:4px;">Jl. Ratu Dibalau, Way Kandis, Kec. Tj. Senang, Kota Bandar Lampung, Lampung 35131</h4>
				 	</td>
				</tr>
				...
				<tr>
				 	<td colspan="7" align="center">
						...
						?>
							...
							<h3 align="center">Laporan Penjualan Harian - Tanggal <?php echo $a." ".$bln." ".$c; ?></h3>
						<?php }else{ ?>
							<h3 align="center">Laporan Penjualan Harian - Dari Tanggal <?php echo $aa." ".$bln1." ".$ac; ?> &nbsp;-&nbsp;<?php echo $ba." ".$bln2." ".$bc; ?></h3>
						<?php } ?>
