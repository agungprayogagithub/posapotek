...
<body onLoad="window.print()" style="font-family:'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma,  sans-serif;width:21cm;">
		<table width="150%" border="0" cellpadding="2" cellspacing="0">
			<thead>
				<tr>
				 	...
				 	<td colspan="10" align="center">
				 		<h1 style="margin:0">Toko Niaga Grosir</h1>
				 		<h4 style="margin:0;margin-top:4px;">Bandar Lampung</h4>
				 	</td>
				</tr>
				...
				<tr>
					...
					<th width="10%"  style="border:1px solid black">Kode Barang</th>
					<th width="15%"  style="border:1px solid black">Nama Barang</th>
					<th width="6%" style="border:1px solid black">Satuan</th>
					<th  width="20%" style="border:1px solid black">Supplier</th>
					<th width="10%" style="border:1px solid black">Harga</th>
					<th  width="5%"  style="border:1px solid black">Jumlah</th>
					<th  width="30%"  style="border:1px solid black">Total Harga</th>
				</tr>
			</thead>
			<tbody>
				<?php  
			...
			<tr>
				<td colspan="10" align="Right"><?php echo $hrskrg.", ".date(" j ").$blnskrg.date(" Y "); ?></td>
			</tr>
			<tr>
				<td colspan="10" align="right">Hormat Saya,</td>
			</tr>
			<tr><td>&nbsp;</td></tr>
			<tr><td>&nbsp;</td></tr>
			<tr><td>&nbsp;</td></tr>
			<tr>
				<td colspan="10" align="right"><?php echo $_SESSION['nama']; ?></td>
			</tr>
