<?php
	...
	@$sql2 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_transaksi_detail WHERE no_transaksi = '$no_transaksi'"));
...
<table>
	<tr><td colspan="4" align="center"><strong><div class="pt">APOTEK ASSIPA WAY KANDIS</div></strong></td></tr>
	<tr><td colspan="4" align="center">Jl. Ratu Dibalau, Way Kandis,<br> Kec. Tj. Senang, Kota Bandar Lampung, Lampung 35131</td></tr>
	<tr><td colspan="4">----------------------------------------------------</tr>
	<tr>
		<td colspan="2"><?php echo @$no_transaksi; ?></td>
		<td colspan="2" align="right">Nama Kasir : <?php echo @$kasir; ?></td>
	</tr>
	<tr>
		<td colspan="2"><?php echo @$tanggal; ?></td>
		<td colspan="2" align="right">Nama Konsumen : <?php echo @$konsumen; ?></td>
	</tr>
	<tr><td colspan="4">----------------------------------------------------</tr>
	<tr>
		<td>Barang</td>
