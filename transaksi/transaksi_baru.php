				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon"><div class="glyphicon glyphicon-text-size"></div></span>
								<input type="text" name="tkonsumen" id="tkonsumen" value="<?php echo @$edit['banyak']; ?>" class="form-control" required placeholder="Nama Konsumen" class="form-control" autofocus>	
							</div>
						</div>
			...
			<div class="col-md-9">
				<div class="panel panel-primary" >
					<div class="panel-heading" style="height:40px;">
						<h4 class="panel-title pull-left">APOTEK ASSIPA WAY KANDIS</h4>
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								...
								<tr style="background-color: rgba(44, 62, 80, 0.1);">
									...
									<td colspan="2" align="right"><b>Rp. <?php echo number_format(@$subtotal, 0,'','.'); ?></b></td>
									<td colspan="2"></td>
								</tr>							
							</tbody>
						</table>
