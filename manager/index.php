...
<body>
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.php">PEMILIK</a>
		</div>
		<!-- akhir dari navbar atas -->
		<div class="navbar-collapse collaspse">
			<ul class="nav navbar-nav">
				<li class="dropdown" id="hov">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#" id="laporan"><div class="glyphicon glyphicon-eye-open"></div>&nbsp;&nbsp; MONITORING <span class="caret"></span>
					</a>
...
<a href="?menu=daftarpenjualan">Daftar Transaksasi Penjualan</a>
	...
	<?php  
		switch (@$_GET['menu']) {
			...
			case 'daftarpenjualan':include '../transaksi/daftar_penjualan2.php'; break;
