...
<head>
        ...
        <title>APOTEK ASSIPA WAY KANDIS</title>
		...
		<div class="col-md-6">
			<div class="panel panel-primary" style="margin-top:120px;">
				<div class="panel-heading" style="padding:20px;">
					...
					<div style="font-size:200%;"><strong>PANGKALAN GAS SUPARMAN</strong></S></div>
					<div class="col-md-1"></div>
					<div style="font-size:100%;">A P L I K A S I &nbsp; P E N J U A L A N</div>
				</div>
				...
				<div class="panel-footer" align="center">
						&copy;2023 - APOTEK ASSIPA BANDAR LAMPUNG
				</div>
			</div>
		</div>
