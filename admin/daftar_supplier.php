									...
									<?php  
										...
										if ($a=="") {
											...
											foreach ($a as $data) {
												...
												<td><?php echo $almt; ?></td>
												<td><?php echo $nohp; ?></td>
												<td><a href="?menu=daftarsupplier&hapus&id=<?php echo $kdsup; ?>" onClick="return confirm('Anda Yakin Akan Menghapus Supplier <?php echo $nm ?> ini ?')"><center><span class='glyphicon glyphicon-trash' id='red'></span></center></a></td>
