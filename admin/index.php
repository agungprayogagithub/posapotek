...
<body>
			...
			<ul class="nav navbar-nav">
				<li class="dropdown" id="hov">
					...
					<ul class="dropdown-menu" aria-labelledby="input">
						...
						<li>
							<a href="?menu=pembelianbarang">Kelola Daftar Pembelian Barang</a>
						</li>
			...
			<ul class="nav navbar-nav">
				<li class="dropdown" id="hov">
					...
					<ul class="dropdown-menu" aria-labeldby="laporan">
						<li class="divider"></li>
						<li>
							<a href="?menu=laptransaksiharian">Laporan Transaksi Penjualan &nbsp;(Harian)</a>
						</li>
						<li>
							<a href="?menu=laptransaksibulanan">Laporan Transaksi Penjualan &nbsp;(Bulanan)</a>
	...
	<?php  
		switch (@$_GET['menu']) {
			...
			case 'laptransaksisewabulanan':include '../laporan/laporan_transaksi_penyewaan.php';break;
